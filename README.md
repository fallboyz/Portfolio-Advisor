...
시스템의 자동 분석은 숫자 계산(저평가/고평가 판단)까지만 수행합니다. MCP를 통해 Claude가 데이터를 직접 조회하면, 숫자 뒤의 시장 맥락을 해석하고 종합적인 판단 코멘트를 제공합니다.
...
상세 공식과 지표 선정 근거는 [docs/analysis-model.md](docs/analysis-model.md)를 참조하세요.
